...
pub mod secrets {
    ...
    pub async fn list_secrets(Path(org_id): Path<String>) -> Json<SecretResponse> {
    ...
    pub async fn get_secret(Path(id): Path<Uuid>) -> Json<Secret> {
...
pub mod projects {
    ...
    pub async fn list_projects(Path(org_id): Path<String>) -> Json<ProjectsResponse> {
    ...
    pub async fn get_project(Path(id): Path<String>) -> Json<Project> {
